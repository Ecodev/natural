...
import {type Route, type UrlMatcher, type UrlMatchResult, type UrlSegment, type UrlSegmentGroup} from '@angular/router';
import {flatten, merge} from 'es-toolkit';
import {type NaturalPanelConfig, type NaturalPanelsRouterRule} from './types';
